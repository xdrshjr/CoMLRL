...
class MAGRPOTrainer:
    ...
    Only supports shared reward functions.
    ...
    def __init__(
        ...
        model_config: Optional[Dict[str, Any]] = None,  # Simplified to dict only
    ...
    def evaluate(self, num_eval_samples: int = 4) -> Dict[str, float]:
        ...
        Args:
            num_eval_samples: Number of samples to evaluate (default: 4)
        ...
        **kwargs,
        ...
        try:
            ...
            if num_return_sequences > 1:
                ...
                # Add any model-specific generation kwargs
                generation_update.update(self.model_config.get("generation_kwargs", {}))
